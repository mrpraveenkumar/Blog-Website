...
const Logo = () => {
  return (
    <Link href="codehex.link" className="flex items-center text-dark dark:text-light">
        ...
        <span className="font-bold dark:font-semibold text-lg md:text-xl">CodeHex</span>
    </Link>
  )
}
